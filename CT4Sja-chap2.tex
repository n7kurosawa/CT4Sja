...
A\ar[r]_f&B\ar[r]_g&C}
$$
右側の四角形には$B'\iso B\times_CC'$が引き戻しであることを示す鉤記号がある. しかし左側の鉤記号は曖昧である. これは左側の四角形が引き戻しであることを示しているのかもしれないし, 全体の四角形が引き戻しであることを示しているのかもしれない. しかし, もし$B'\iso B\times_CC'$ならば曖昧でないことが分かる. なぜならば左側の四角形が可換であることと全体の四角形が可換であるのは同値だからである.
